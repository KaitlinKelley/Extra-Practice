...
function findThree(array) {
        var randomArray = [];
    for (var i = 0; i < 3; i++) {
        randomArray.push(Math.floor((Math.random() * 199)));
    }
        // console.log(randomArray);
    var firstVal = numbers[randomArray[0]];
    var secondVal = numbers[randomArray[1]];
    var thirdVal = numbers[randomArray[2]];
    // console.log(firstVal + secondVal + thirdVal);
    if(firstVal + secondVal + thirdVal === 2020){
        console.log("STOP!!");
        console.log("These three: " + randomArray);
        // return randomArray;
    }
    return randomArray;
}
...
// console.log(numbers[111] * numbers[59] * numbers[138]);
